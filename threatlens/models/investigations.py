"""Investigation output models – structured results from all investigation types."""
...
from threatlens.models.entities import ResolvedEntity, ThreatIntelHit
from threatlens.models.incidents import Severity


# ── Triage ─────────────────────────────────────────────────────────────────────

class TriageReport(BaseModel):
    """Full triage output produced by the TriageEngine."""
...
class ResourceInvestigation(BaseModel):
    """Output of an Azure resource investigation."""
    ...
    access_anomalies: list[str] = Field(default_factory=list)
